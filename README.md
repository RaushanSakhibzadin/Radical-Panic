...
- Each planted friend grows a Nectar drop every few seconds. It hovers over the friend that made it, then flies to the counter in the top-right corner and banks itself — no chasing. Each Nectar gives one Spark, so the garden keeps growing on its own.
